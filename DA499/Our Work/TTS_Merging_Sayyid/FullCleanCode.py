...
def Optimize_speed_to_match_video(video_path, audio_path, speeded_audio_path):                                 
    video_duration = Duration(video_path)                                                                      ##  هون بنحسب مدة الفيديو باستخدامالفنكشن  يلي فوق
    audio_duration = Duration(audio_path)                                                                      ##  هون بنحسب مدة الصوت باستخدام الفنكشن  يلي فوق
