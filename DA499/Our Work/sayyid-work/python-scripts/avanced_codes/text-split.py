...
# اسم ملف النص الأصلي
file_path = r"C:\Users\sauui\XTTS-project\sayyid-work\test-text\new-video.txt"

# اسم ملف CSV الناتج
output2_csv = "timing2_sentences_.csv"
...
with open(output2_csv, "w", newline="", encoding="utf-8") as csv_file:
