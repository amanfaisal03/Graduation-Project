    ...
    def __init__(self, model = "qwen-2.5-32b" ,api_key="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",Text=None,Online=True):
        ...
        self.Prompts = {
                        ...
                        ,"Keywords" : "based on the following text that represente a video transcript, I want you to specify the most improtant keywords (the words that are improtant to know for any one want to be good in the video filed) \
                            in the arabic language and give them to me with a short summary about each one of them also in the Arabic language. The text :"+f"\n'''{self.C_Text }'''..\nPlease remember: I want the keywords to be shown without any introductory phrases like \بعد تحليل النص، تم تحديد أهم الكلمات الرئيسية في مجال الفيديو، وترجمت إلى اللغة العربية مع ملخص قصير لكل كلمة: \" or 'Here are the most important keywords in the Arabic language with a short summary for each:'. \
                                Also, the formate of the keywords should be like this: \n1.  **Arabic keyword1 (english keyword1)**: summary1\n2.  **Arabic keyword2 (english keyword2)**: summary2\n ..etc.note :dont put any number before the keywords."
